...
Dataset used (`R/demoR/server/bnc.rds`): British National Corpus, bag of representation of 1335 documents of four genres (conversation, fiction, broadsheet newspaper, academic). See Puolamäki et al. (2017) for more information about the dataset used.
